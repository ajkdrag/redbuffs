...
_Senior Software Engineer (ML)_ | Mar 2023 - Present | Bengaluru

- Built Kubeflow MLOps with GitLab integration
- Document intelligence projects: KYC verification (VLMs), data extraction models
...
- End-to-end MLOps pipeline on AWS with drift monitoring
- Optimized Kubernetes for 48 cameras @12fps using 12 GPUs (<3s latency)
- NVIDIA Deepstream POC for crowd density tracking

_Data Engineer_ | Oct 2019 - Mar 2021

- Built Python Data Lake framework with ETL, job recovery features
- Large-scale migration: 15K+ tables from Teradata to Snowflake
- Developed accelerators: SQL syntax converters, data validation tools

## Education

NIT Silchar : _M.Tech, Computer Science_ | Assam, India
...
For more, check out my [GitHub](https://github.com/ajkdrag).
