---
{"publish":true,"created":"2025-02-11T11:54:06.505+05:30","tags":["type/zettel","status/done"],"cssclasses":""}
---
...
- [[2 Zettels/frequency array using coordinate compression\|frequency array using coordinate compression]]: when the range of values is very large (e.g., up to 10^9), but the number of distinct elements is relatively small
- character frequency arrays: `for (char c : s) freq[c - 'a']++;`
- [[2 Zettels/frequency array for negative numbers\|frequency array for negative numbers]]: uses offset technique
